...
int layer1[44] = {
    ...
    FUNCTION(2), SHIFT(KEY_INSERT), KEYBOARD_LEFT_GUI, KEYBOARD_LEFT_SHIFT, KEY_BACKSPACE,
    KEYBOARD_LEFT_CTRL,
...
int *layers[] = {layer0, layer1, layer2, layer3, layer1};
...
void (*layer_functions[])(void) = {reset, activate_fn, on_release_2, hwcolemak};
